...
% Define highlighting command for revised text
\newcommand{\revised}[1]{\colorbox{yellow!30}{#1}}
\newcommand{\revisedblock}[1]{\begin{tcolorbox}[colback=yellow!10,colframe=orange!60,boxrule=0.5pt,arc=2pt,left=3pt,right=3pt,top=3pt,bottom=3pt]#1\end{tcolorbox}}
...
\begin{center}
\small
\colorbox{green!20}{\textbf{ NEW }} = Newly added text \quad
\colorbox{orange!20}{\textbf{ REVISED }} = Modified text \quad
{\color{blue!70!black} Blue text} = Revision content
\end{center}
...
\textbf{Added to Background:} \colorbox{green!20}{\small NEW}

\begin{quote} \scriptsize \color{blue!80!black} More recently, specialized biomedical AI agents have
\scriptsize \color{blue!70!black} emerged as a transformative paradigm for clinical applications, moving beyond
...
\textbf{Revised in Abstract:} \colorbox{orange!20}{\scriptsize\textbf{REVISED}}

\begin{quote} \scriptsize This work demonstrates the impact of
\scriptsize \color{blue!70!black} \textbf{tool-augmented context engineering}---the deliberate design of
...
\textbf{Added to Background:} \colorbox{green!20}{\scriptsize\textbf{NEW}}

\begin{quote} \scriptsize Context-engineering, as recently formalized,
\scriptsize \color{blue!70!black} encompasses the systematic optimization of information payloads for LLMs through
...
\textbf{Added to Discussion:} \colorbox{green!20}{\scriptsize\textbf{NEW}}

\begin{quote} \scriptsize MARRVEL-MCP represents a specific instantiation of
\scriptsize \color{blue!70!black} context engineering focused on tool-mediated database access. Recent taxonomies
...
\textbf{Added to Implementation:} \colorbox{green!20}{\scriptsize\textbf{NEW}}

\begin{quote} \scriptsize We manually constructed a benchmark dataset of 100
\scriptsize \color{blue!70!black} questions designed to evaluate variant interpretation capabilities answerable
...
\scriptsize \color{blue!70!black} stages: response generation, automated judging with manual review, and
...
\textbf{Added to Results:} \colorbox{green!20}{\scriptsize\textbf{NEW}}

\begin{quote} \scriptsize Equipping lightweight models with MARRVEL-MCP
\scriptsize \color{blue!70!black} substantially improved their accuracy on variant interpretation tasks, enabling
...
\begin{itemize}
\item Benchmark \textbf{Gemini 3.0} and \textbf{GPT-5} on evaluation set
...
\scriptsize \color{blue!70!black} Context-engineering, as recently formalized, encompasses the systematic
